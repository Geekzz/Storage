...
namespace Storage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            IEnumerable<ProductViewModel> products = GetProductFromDatabase();
            return View(products);
        }

        private IEnumerable<ProductViewModel> GetProductFromDatabase()
        {
            var productList = _context.Product.Select(p => new ProductViewModel
            {
                Name = p.Name,
                Price = p.Price,
                Count = p.Count,
